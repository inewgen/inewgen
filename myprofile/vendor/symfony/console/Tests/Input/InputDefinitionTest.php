...
class InputDefinitionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getGetSynopsisData()
    {
        return array(
            ...
            array(new InputDefinition(array(new InputArgument('foo', InputArgument::IS_ARRAY))), '[<foo>]breakprice', 'uses an ellipsis for array arguments'),
            array(new InputDefinition(array(new InputArgument('foo', InputArgument::REQUIRED | InputArgument::IS_ARRAY))), '<foo> (<foo>)breakprice', 'uses parenthesis and ellipsis for required array arguments'),
