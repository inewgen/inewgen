        ...
        <div class="row footer-widgets">
            ...
            <div class="col-md-3 col-xs-12">
                <div class="footer-widget flickr-widget">
                    ...
                    <ul class="flickr-list">
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr01.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr01.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr02.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr02.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr03.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr03.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr04.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr04.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr05.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr05.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr06.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr06.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr07.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr07.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr08.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr08.png">
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo URL::to('public/themes/margo');?>/images/flickr09.png" class="lightbox">
                                <img alt="" src="<?php echo URL::to('public/themes/margo');?>/images/flickr09.png">
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-3 col-xs-12">
                <div class="footer-widget contact-widget">
                    <h4><img src="<?php echo URL::to('public/themes/margo');?>/images/simits_logo_footer.png" class="img-responsive" alt="Footer Logo" /></h4>
