...
<div class="page-banner">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2>News</h2>
                <p><?php echo array_get($news, 'title', '');?></p>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumbs">
                    <li><a href="<?php echo URL::to('');?>">Home</a></li>
                    <li><a href="<?php echo URL::to('news');?>">News</a></li>
                    <li><?php echo array_get($news, 'title', '');?></li>
                </ul>
            </div>
        </div>
    </div>
...
?>
                    ...
                    <div class="post-content">
                        ...
                        <h2><?php echo array_get($news, 'title', '');?></h2>
                        <ul class="post-meta">
                            <li>By <a href="#"><?php echo array_get($author, 'name', '');?></a></li>
                            <li><?php echo $m;?> <?php echo $d;?>, <?php echo $y;?></li>
                            <li><a href="#"><?php echo array_get($news, 'categories.title', '');?></a></li>
                            <li><a href="#"><span class="disp_views"><?php echo number_format(array_get($news, 'views', '0'));?></span> Views</a></li>
                        </ul>
                        <p><?php echo $news['description'];?></p>

<?php if ($reference = array_get($news, 'reference', false)): ?>
                        <div class="post-bottom-tags">
                            <div class="post-share">
                                <i class="fa fa-thumb-tack"></i> ที่มา :
                                <span class="">
<?php if ($reference_url = array_get($news, 'reference_url', false)): ?>
...
<?php if ($tags = array_get($news, 'tags', false)): ?>
...
<?php endif;?>
                        ...
                        <div class="post-bottom-tags">
                            <div class="post-tags-list">
                            	<i class="fa fa-eye"></i> Views : <span class="disp_views"><?php echo number_format(array_get($news, 'views', '0'));?></span>
                        	</div>
                        ...
                        <div class="post-bottom clearfix">
                            <div class="post-tags-list">
                                ...
                                <span class="disp_likes">
                                    <?php echo number_format(array_get($news, 'likes', '0'));?>
                                </span>
                                ...
                                <span class="disp_unlikes">
                                    <?php echo number_format(array_get($news, 'unlikes', '0'));?>
                                </span>
                            </div>
                            ...
                            <div class="post-share">
                                ...
                                <!-- <a class="facebook" href="https://www.facebook.com/dialog/feed?app_id=876049622442009&display=popup&caption=<?php echo $news['title'];?>&link=http://www.inewgen.loc/news/40&redirect_uri=http://www.inewgen.loc/news/40"><i class="fa fa-facebook"></i></a>
                ...
                <div id="comments">
                    ...
                    <div id="respond">
                        ...
                        <form id="frm_main" role="form" method="post" action="<?php echo URL::to('news/addcomment');?>" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                            	<div class="col-md-12">
                                	<input name="commentable_id" type="hidden" id="commentable_id" value="<?php echo array_get($news, 'id', '');?>">
                                    <input name="referer" type="hidden" id="referer" value="<?php echo URL::to('news');?>/<?php echo array_get($news, 'id', '');?>#addcomments">
